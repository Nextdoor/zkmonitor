...
setup(
    name=PACKAGE,
    version=__version__,
    description='Zookeeper Monitoring Service',
    long_description=open('README.md').read(),
    author='Nextdoor Engineering',
    author_email='eng@nextdoor.com',
    url='https://github.com/Nextdoor/zkmonitor',
    ...
    dependency_links = [
      'git+git://github.com/equeny/tornadomail.git@e413b81450bf94b4db3cad1815affb8b2dce6b41#egg=tornadomail-master'
    ],
    entry_points={
        'console_scripts': [
